$("#success").hide();
$.ajax({
        url: "/user/salonServiceDetail/salonServiceDetailByName/Female?Type=Hair",
        type: 'GET',
...
$.ajax({
        url: "/user/salonServiceDetail/salonServiceDetailByName/Female?Type=Skin",
        type: 'GET',
        dataType: 'json', // added data type
        success: function(res) {
            var skin_elements=``;
...
$.ajax({
        url: "/user/salonServiceDetail/salonServiceDetailByName/Female?Type=Body",
        type: 'GET',
        dataType: 'json', // added data type
        success: function(res) {
            var body_elements=``;
